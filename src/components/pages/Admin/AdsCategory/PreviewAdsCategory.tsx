...
function PreviewAdsCategoryDialog({ open, selected, handleClose }: Props) {
          ...
          >
            <Grid container spacing={1}>
              <Grid size={sizing}>
                <InfoBox
                  title="Start date"
                  value={dayjs(selected?.start_date).format(FULL_DATE_FORMAT)}
                />
              </Grid>
              <Grid size={sizing}>
                <InfoBox
                  title="End date"
                  value={dayjs(selected?.end_date).format(FULL_DATE_FORMAT)}
                />
              </Grid>
              <Grid size={sizing}>
                <InfoBox
                  title="Created date"
                  value={dayjs(selected?.created_at).format(FULL_DATE_FORMAT)}
                />
              </Grid>
...
export default PreviewAdsCategoryDialog;
