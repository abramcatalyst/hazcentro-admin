...
function DifferentStateDeliveryFeeDialog({ open, data, handleClose }: Props) {
  ...
  let initialValues = {
    delivery_fee_different_state:
      data?.delivery_fee_different_state?.value || "",
  };
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      delivery_fee_different_state: yup
        .number()
        .positive()
        .required()
        .label("Amount"),
                  ...
                  <Grid size={{ xs: 12 }}>
                    <FormControl fullWidth sx={{ my: 1 }}>
                      ...
                      <OutlinedInput
                        ...
                        name="delivery_fee_different_state"
                        type="number"
                        value={values.delivery_fee_different_state}
                        onChange={handleChange}
                        onBlur={handleBlur}
                      />
                      {touched.delivery_fee_different_state &&
                      errors.delivery_fee_different_state ? (
...
export default DifferentStateDeliveryFeeDialog;
