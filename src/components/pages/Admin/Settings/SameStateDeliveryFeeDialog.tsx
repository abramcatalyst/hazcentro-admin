...
function SameStateDeliveryFeeDialog({ open, data, handleClose }: Props) {
  ...
  let initialValues = {
    delivery_fee_same_state: data?.delivery_fee_same_state?.value || "",
  };
                  ...
                  <Grid size={{ xs: 12 }}>
                    <FormControl fullWidth sx={{ my: 1 }}>
                      ...
                      <OutlinedInput
                        ...
                        name="delivery_fee_same_state"
                        type="number"
                        value={values.delivery_fee_same_state}
                        onChange={handleChange}
                        onBlur={handleBlur}
                      />
                      {touched.delivery_fee_same_state &&
                      errors.delivery_fee_same_state ? (
...
export default SameStateDeliveryFeeDialog;
